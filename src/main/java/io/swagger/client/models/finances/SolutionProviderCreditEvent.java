...
public class SolutionProviderCreditEvent {
  ...
  **/
  @ApiModelProperty(value = "The date and time that the credit transaction was created, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.")

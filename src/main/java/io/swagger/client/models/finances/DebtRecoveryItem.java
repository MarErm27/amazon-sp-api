...
public class DebtRecoveryItem {
  ...
  **/
  @ApiModelProperty(value = "The beginning date and time of the financial event group that contains the debt. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.")
   ...
   * @return groupEndDate
  **/
  @ApiModelProperty(value = "The ending date and time of the financial event group that contains the debt. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.")

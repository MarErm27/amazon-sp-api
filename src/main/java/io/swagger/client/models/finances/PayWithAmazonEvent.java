...
public class PayWithAmazonEvent {
  ...
  **/
  @ApiModelProperty(value = "The date and time when the payment transaction is posted. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.")
